                    ...
                    <div class="card-body">
                        <form method="" class="" id="form-user">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control notif" name="branch_id" value="{{isset($data) ? $data->branch_id : null}}">
                                <label class="validation-invalid-label notif" id="branch_id"></label>
                            </div>
                            <div class="form-group">
                                <label>Branch Name</label>
                                <input type="text" class="form-control" name="branch_name" value="{{ is_null(old('branch_name')) ? (isset($data) ? $data->branch_name : null) : old('branch_name') }}">
                                <label class="validation-invalid-label notif" id="branch_name"></label>
                            </div>
                            <div class="form-group">
                                <label>Branch Region</label>
                                <input type="text" class="form-control" name="branch_address" value="{{ is_null(old('branch_address')) ? (isset($data) ? $data->branch_address : null) : old('branch_address') }}">
