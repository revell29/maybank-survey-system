                ...
                <div class="card-body">
                    <form method="" class="" id="form-user">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control notif" readonly name="branch_id"
                                value="{{isset($data) ? $data->branch_id : null}}">
                            <label class="validation-invalid-label notif" id="branch_id"></label>
                        </div>
                        <div class="form-group">
                            <label>Branch Name</label>
                            <input type="text" class="form-control" readonly name="branch_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" readonly name="branch_address"
