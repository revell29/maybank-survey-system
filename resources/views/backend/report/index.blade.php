    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                <a href="{{route('report.index')}}" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a>
...
<script type="text/javascript">
    ...
    $(".dataTables_filter").append("<div class='row' id='join'><form action='{{route('Report::exportIndex')}}'>"+
