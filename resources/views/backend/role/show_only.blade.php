        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="" class="" id="form-role">
                            <div class="form-group">
                                <label>Role Name</label>
                                <input type="text" class="form-control notif" name="name" readonly value="{{isset($data) ? $data->name : null}}">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::textarea('description', isset($data) ? $data->description : null, ['class' => 'form-control m-input', 'placeholder' => 'Enter Description','readonly']) !!}
                                        ...
                                        @foreach($permission as $p)
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <div class="">
                                                        <span class="">
                                                            {!! Form::checkbox('permissions[]', $p->id, isset($data) ? $data->hasPermission($p->name) : '',['class' => 'form-check-input-styled','readonly']) !!}
                                                        </span>
                                                    </div>
                                                    {{$p->display_name}}
                                                </label>
