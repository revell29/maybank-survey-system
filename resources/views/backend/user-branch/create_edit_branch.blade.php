                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="" class="" id="form-user">
                            ...
                            <div class="form-group">
                                <label>Branch</label>
                                {!! Form::select('branch_id',$options['branches'],isset($data) ? $data->branch_id : null,['class' => 'select form-control']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" value="{{ is_null(old('username')) ? (isset($data) ? $data->username : null) : old('username') }}">
