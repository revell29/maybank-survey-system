...
@section('content')
   ...
   <!-- Page header -->
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                ...
                <div class="header-elements d-none">
                    ...
                    <a href="{{route('user_branch.create')}}" class="btn btn-labeled btn-labeled-left bg-primary">New Branch User <b><i class="icon-add"></i></b></a>
                    @endpermission
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    ...
                    <a href="{{route('user_branch.index')}}" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
                </div>
            </div>
        </div>
	<!-- /page header -->
    ...
    <div class="content">
        <div class="card">
            <table class="table table-hover table-bordered table-xxs datatable-select-checkbox" id="data-table" data-url="{{route('user_branch.index')}}">
                <thead>
                <tr>
...
var table = $('#data-table').DataTable({
        ...
        columns: [
            ...
            { data: 'ip_address2', name: 'ip_address2' },
        ]
    })
</script>
@endpush
